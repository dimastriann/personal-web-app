        ...
        <section className="flex flex-col items-center justify-center h-screen text-center px-4 pt-5 overflow-auto">
            ...
            <div className="max-w-xl text-blue-100 text-lg leading-relaxed px-6">
                <p>
                    ...
                    with modern JavaScript and Python frameworks especially in
                    Odoo ERP. I enjoy solving complex problems, designing
                    user-friendly interfaces, and delivering efficient, scalable
                    software solutions.
                </p>
                <p className="mt-4">
                    With a strong foundation in full-stack development and a
                    passion for clean code, I strive to create software that not
                    only works but excels in performance and maintainability.
                </p>
            </div>
        </section>
    );
